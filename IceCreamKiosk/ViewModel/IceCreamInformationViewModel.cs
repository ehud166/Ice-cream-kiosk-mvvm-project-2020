...
{
    public class IceCreamInformationViewModel : ViewModelBase
    {
        ...
        public IceCreamInformationViewModel():base()
        {
        ...
        private async Task loadMap(TravelModeType travelModeType)
        {
            ...
            Messenger.Default.Send<IceCreamInformationViewModel>(this);
        }
